...
function docker-build() {
    ...
    # Run the api-queue-consumer build
    printf "${Cyan}Building ghcr.io/st-mark-reformed/stmarkreformed.com-api-queue-consumer${Reset}\n";
    DOCKER_BUILDKIT=1 docker build \
        --build-arg BUILDKIT_INLINE_CACHE=1 \
        --cache-from ghcr.io/st-mark-reformed/stmarkreformed.com-api-queue-consumer \
        --file docker/api-queue-consumer/Dockerfile \
        --tag ghcr.io/st-mark-reformed/stmarkreformed.com-api-queue-consumer \
        ${WORK_DIR};
    printf "${Green}Finished building ghcr.io/st-mark-reformed/stmarkreformed.com-api-queue-consumer${Reset}\n\n";

    # Run the api-schedule-runner build
    printf "${Cyan}Building ghcr.io/st-mark-reformed/stmarkreformed.com-api-schedule-runner${Reset}\n";
    DOCKER_BUILDKIT=1 docker build \
        --build-arg BUILDKIT_INLINE_CACHE=1 \
        --cache-from ghcr.io/st-mark-reformed/stmarkreformed.com-api-schedule-runner \
        --file docker/api-schedule-runner/Dockerfile \
        --tag ghcr.io/st-mark-reformed/stmarkreformed.com-api-schedule-runner \
        ${WORK_DIR};
    printf "${Green}Finished building ghcr.io/st-mark-reformed/stmarkreformed.com-api-schedule-runner${Reset}\n\n";
