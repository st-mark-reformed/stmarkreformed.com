...
export default async function EditHymnOfTheMonthSubmitFormAction (
    ...
    const hymnOfTheMonthIdValue = formData.get('hymnOfTheMonthId');
    const hymnOfTheMonthId = typeof hymnOfTheMonthIdValue === 'string'
        ? hymnOfTheMonthIdValue
        : '';
