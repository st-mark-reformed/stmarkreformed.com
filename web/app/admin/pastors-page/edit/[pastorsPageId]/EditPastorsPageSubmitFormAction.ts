...
export default async function EditPastorsPageSubmitFormAction (
    ...
    const pastorsPageIdValue = formData.get('pastorsPageId');
    const pastorsPageId = typeof pastorsPageIdValue === 'string' ? pastorsPageIdValue : '';
