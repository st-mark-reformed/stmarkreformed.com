...
class PastorsPageListActionTest extends TestCase
{
    use MockPageNumberFactoryForTesting;

    private PastorsPageListAction $action;
    ...
    protected function setUp(): void
    {
        ...
        $this->action = new PastorsPageListAction(
    ...
    public function testAddRoute(): void
    {
        ...
        PastorsPageListAction::addRoute(routeCollector: $routeCollector);
    ...
    public function testInvoke(): void
    {
        ...
        self::assertSame('pastorsPage', $call1Args[1]);
