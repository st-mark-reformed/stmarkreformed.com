...
final class ResourcesRedisKey
{
    private const string NAMESPACE = 'api-resources:';
    ...
    public static function slug(string $resourceSlug): string
    {
        return self::NAMESPACE . 'slug:' . $resourceSlug;
    }
