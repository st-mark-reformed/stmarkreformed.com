...
readonly class InternalMessage implements JsonSerializable
{
    ...
    public function __construct(
        ...
        public InternalSeries $series = new EmptyInternalSeries(),
    ...
    public function withAudioFileSize(int $value): self
    {
        return new self(
            id: $this->id,
            isEnabled: $this->isEnabled,
    ...
    public function withSeries(InternalSeries $value): self
    {
        return new self(
            id: $this->id,
            isEnabled: $this->isEnabled,
