 ...
 * @codeCoverageIgnore
 *
 * This is an old class I drag from project to project. It's a bit big and
 * overwhelming and I don't have the energy to re-write it, resize it, or write
 * tests for it. But it is battle proven.
 */
class Pagination
{
    private int $pad = 2;
    ...
    private string|null $calcPrevPageLink = null;

    public function prevPageLink(): string|null
    {
        if ($this->calcPrevPageLink === null) {
            ...
            if ($this->queryStringBased) {
                ...
                $this->calcPrevPageLink = $this->prevPage() > 1 ?
                    $base . '/page/' . $prevPage . $this->queryString() :
    ...
    public function nextPageLink(): string|null
    {
    ...
    public function firstPageLink(): string|null
    {
    ...
    public function lastPageLink(): string|null
    {
        ...
        if (! $this->queryStringBased) {
            ...
            return $base . '/page/' . $totalPages . $queryString;
        }
    ...
    /** @var mixed[]|null */
    private array|null $calcPagesArray = null;
