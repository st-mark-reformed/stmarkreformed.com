...
class EnqueueGenerateMenOfTheMarkPagesForRedis
{
    ...
    public function enqueue(): void
    {
        ...
        foreach ($queueItems as $queueItem) {
            ...
            if ($desc !== GenerateMenOfTheMarkPagesForRedisQueueJob::DESCRIPTION) {
                continue;
            }
        ...
        $this->queue->push(
            new GenerateMenOfTheMarkPagesForRedisQueueJob()
        );
    }
}
